                            ...
                            <tbody>
                                ...
                                @foreach ($orderConfirm as $items)
                                    <tr>
                                        ...
                                        <td>{{ $items->note }}</td>
                                        <td>
                                            <a href="/admin/order/removeOrder/{{ $items->id }}"
                                                class="btn btn-danger float-right m-2">Hủy đơn</a>
                                            <a href="/admin/order/shipSuccess/{{ $items->id }}"
                                                class="btn btn-success float-right m-2">Giao hàng thành công</a>
                                        </td>
                                    </tr>
                                @endforeach
